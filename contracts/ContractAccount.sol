...
contract ContractAccount is IContractAccount {
  ...
  function addVotingToken(address daoAddress, address tokenAddress, bool isERC1155) external {
  ...
  function approveVotingToken(address daoAddress, uint256 amount, uint256 tokenId) external {
